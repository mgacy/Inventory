...
class SettingsCoordinator: BaseCoordinator<SettingsCoordinationResult> {
    ...
    override func start() -> Observable<CoordinationResult> {
        ...
        let login = viewModel.showLogin
            .asObservable()
            .flatMap { [weak self] _ -> Observable<LoginCoordinationResult> in
    ...
    private func showLogin(on rootViewController: UIViewController) -> Observable<LoginCoordinationResult> {
